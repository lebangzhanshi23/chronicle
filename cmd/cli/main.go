...
var (
	...
	flagDeadline  string
	flagStatus    string
	flagNewStatus string
)

func init() {
	flag.StringVar(&flagCategory, "c", "", "Category")
	flag.StringVar(&flagCategory, "category", "", "Category")
	flag.StringVar(&flagDesc, "d", "", "Description")
	flag.StringVar(&flagDesc, "desc", "", "Description")
	flag.StringVar(&flagLinks, "l", "", "Links (one per line)")
	flag.StringVar(&flagLinks, "links", "", "Links")
	flag.StringVar(&flagTargets, "t", "", "Targets")
	flag.StringVar(&flagTargets, "target", "", "Targets")
	flag.StringVar(&flagDeadline, "deadline", "", "Deadline (ISO8601)")
	flag.StringVar(&flagStatus, "status", "", "Status filter")
	flag.StringVar(&flagNewStatus, "new-status", "", "New status")
}
...
func handleUpdate(args []string) {
	...
	fs.StringVar(&flagCategory, "c", "", "Category")
	fs.StringVar(&flagCategory, "category", "", "Category")
	fs.StringVar(&flagDesc, "d", "", "Description")
	fs.StringVar(&flagDesc, "desc", "", "Description")
	fs.StringVar(&flagLinks, "l", "", "Links")
	fs.StringVar(&flagLinks, "links", "", "Links")
	fs.StringVar(&flagTargets, "t", "", "Targets")
	fs.StringVar(&flagTargets, "target", "", "Targets")
	fs.StringVar(&flagDeadline, "deadline", "", "Deadline")
	fs.StringVar(&flagNewStatus, "new-status", "", "New status")
	fs.Parse(args)
	...
	taskID := fs.Args()[0]
	deadline := parseDeadline(flagDeadline)

	if flagNewStatus != "" {
		progressReq := model.UpdateProgressReq{
			NewStatus: flagNewStatus,
		}
